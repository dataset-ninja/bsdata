...
PROJECT_NAME_FULL: str = "BSData: Industrial Machine Tool Element Surface Defect Dataset"
...
SLYTAGSPLIT: Optional[Union[Dict[str, List[str]], str]] = {
    ...
    "__POSTTEXT__": "Also, it could be categorized by the 27 wear developments (***wear_dev***)",
}
TAGS: List[str] = None
